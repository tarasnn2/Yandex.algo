package ru.yandex.algo.sprint6.d;
...
public class D {
  ...
  private static final String FILE = "/home/taras/repoMy/projects/Yandex.algo/src/main/java/ru/yandex/algo/sprint6/d/input00.txt";
...
class Graph {
  ...
  Queue<Edge> getEdges(Vertex key) {
    final PriorityQueue<Edge> edges = store.getOrDefault(key, new PriorityQueue<>(traversDirect)); //Comparator.comparingInt(e -> e.getW().getNumber()))
